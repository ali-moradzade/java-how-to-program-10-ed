	...
	public DrawFrame()
	{
		...
		saveJButton.addActionListener(
			new ActionListener()
			{
				...
				{
					SaveShapes saveShapes = new SaveShapes(drawPanel.getShapes());
					saveShapes.save();
				}
			}
		);
		...
		loadJButton.addActionListener(
			new ActionListener()
			{
				...
				public void actionPerformed(ActionEvent e)
				{
					LoadShapes loadShapes = new LoadShapes();
					drawPanel.setShapes(loadShapes.load());
					drawPanel.setShapeCount(loadShapes.getShapeCount());
					drawPanel.repaint();
				}
			}
		);
		...
		northJPanel.add(saveJButton);
		northJPanel.add(loadJButton);
