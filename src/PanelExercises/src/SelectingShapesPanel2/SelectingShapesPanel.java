...
public class SelectingShapesPanel extends JPanel 
{
	...
	private final JButton chooseColorJButton;
	...
	public SelectingShapesPanel()
	{
		...
		chooseColorJButton = new JButton("Choose Color");
		chooseColorJButton.addActionListener(
			new ActionListener()
			{
				...
				{
					color = JColorChooser.showDialog(SelectingShapesPanel.this,
	...
	public JComboBox<String> getShapesJComboBox()
	{
		return comboBox;
	}
	
	public JButton getChooseColorJButton()
	{
		return chooseColorJButton;
	}
